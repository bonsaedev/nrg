...
> extends Node<TConfig, TCredentials, TSettings> {
  ...
  public static readonly outputsSchema?: Schema;
  ...
  public send(msg: TOutput) {
    ...
    if (shouldValidateOutput && NodeClass.outputsSchema) {
      ...
      validator.validate(msg, NodeClass.outputsSchema, {
        cacheKey:
          NodeClass.outputsSchema.$id || `${NodeClass.type}:output-schema`,
        throwOnError: true,
      });
  ...
  public override get credentials(): IONodeCredentials<TCredentials> | undefined {
